...
def main():
    parser = argparse.ArgumentParser(description="Install json-diff-view package")
    ...
    parser.add_argument("--git-url", default="https://github.com/your-username/json-diff-view.git", 
